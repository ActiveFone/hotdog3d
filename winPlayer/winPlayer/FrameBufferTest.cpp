...
void FrameBufferTest::showTest(GLFWwindow *window)
{
	...
	// load textures
	// -------------
	cubeTexture = loadTexture("res/img/container.jpg");
	floorTexture = loadTexture("res/img/wall.jpg");
...
void FrameBufferTest::initObject()
{
	// cube VAO
...
void FrameBufferTest::drawObject(Shader shader)
{
	shader.use();
...
void FrameBufferTest::initFrameBuffer()
{	
	// quad VAO
...
void FrameBufferTest::drawScreenBuffer(Shader screenShader)
{
	glBindFramebuffer(GL_FRAMEBUFFER, 0);
